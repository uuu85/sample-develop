...
import com.sample.project.databinding.FragmentPlaneBinding
import com.sample.project.fragment.base.BaseDataBindingFragment
import com.sample.project.viewModel.PlaneViewModel

class PlaneFragment: BaseDataBindingFragment<PlaneViewModel, FragmentPlaneBinding>(
    R.layout.fragment_plane
){
    private val text = "吾輩わがはいは猫である。名前はまだ無い。\n" +
    ...
    override val viewModel: PlaneViewModel by viewModels()

    override fun initView() {
        binding.plane.text = text
    }
}